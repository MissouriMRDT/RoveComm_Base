...
#define RC_BMSBOARD_CELL_UNDERVOLTAGE_DATACOUNT		1 //bitmasked value
...
#define RC_POWERBOARD_MOTOR_BUSENABLE_DATACOUNT       2   //[Enable/Disable][M1, M2, M3, M4, M5, M6, M7, Spare]	(bitmask)
...
#define RC_POWERBOARD_12V_BUSENABLE_DATACOUNT       2   //[Enable/Disable][Act, Logic]  (bitmask)
...
#define RC_POWERBOARD_30V_BUSENABLE_DATACOUNT       2   //[Enable/Disable][12V Board, Rockets, Aux]  (bitmask)
...
#define RC_POWERBOARD_PATCH_PANELENABLE_DATACOUNT       2   //[Enable/Disable][Panels 1-8]  (bitmask)
...
#define RC_POWERBOARD_MOTOR_BUSENABLED_DATACOUNT       2   //[Enabled/Disabled][M1, M2, M3, M4, M5, M6, M7, Spare]	(bitmask)
...
#define RC_POWERBOARD_12V_BUSENABLED_DATACOUNT       2   //[Enabled/Disabled][Act, Logic]  (bitmask)
...
#define RC_POWERBOARD_30V_BUSENABLED_DATACOUNT       2   //[Enabled/Disabled][12V Board, Rockets, Aux]  (bitmask)
...
#define RC_POWERBOARD_PATCH_PANELENABLED_DATACOUNT       2   //[Enabled/Disabled][Panels 1-8]  (bitmask)

//Motor bus current
#define RC_POWERBOARD_MOTOR_BUS_CURRENT_DATAID          05+_TYPE_TELEMETRY+_POWERBOARD_BOARDNUMBER
#define RC_POWERBOARD_MOTOR_BUS_CURRENT_DATATYPE        uint8_t 		
#define RC_POWERBOARD_MOTOR_BUS_CURRENT_DATACOUNT       2   //[M1, M2, M3, M4, M5, M6, M7, Spare]	

//12V bus current
#define RC_POWERBOARD_12V_BUS_CURRENT_DATAID          06+_TYPE_TELEMETRY+_POWERBOARD_BOARDNUMBER
#define RC_POWERBOARD_12V_BUS_CURRENT_DATATYPE        uint8_t 		
...
#define RC_POWERBOARD_30V_BUS_CURRENT_DATATYPE        uint8_t 		
...
#define RC_POWERBOARD_VACUUM_CURRENT_DATATYPE        uint8_t 		
#define RC_POWERBOARD_VACUUM_CURRENT_DATACOUNT       1   

//Patch Panel current
#define RC_POWERBOARD_PATCH_PANEL_CURRENT_DATAID          09+_TYPE_TELEMETRY+_POWERBOARD_BOARDNUMBER
#define RC_POWERBOARD_PATCH_PANEL_CURRENT_DATATYPE        uint8_t 		
#define RC_POWERBOARD_PATCH_PANEL_CURRENT_DATACOUNT       8   //[Panels 1-8] 
