...
#define RC_CAMERABOARD2_FOURTHOCTET            142
#define RC_PR_CONTROLLER_FOURTHOCTET           143
...
#define _BLACKBOX_BOARDNUMBER        04*1000    
#define _N3_BOARDNUMBER              05*1000    
#define _SHIMBLEBOARD_BOARDNUMBER    06*1000
#define _LIGHTING_BOARDNUMBER        07*1000 
...
#define _CAMERABOARD_BOARDNUMBER     12*1000
#define _CAMERABOARD2_BOARDNUMBER    13*1000
#define _PR_CONTROLLER_BOARDNUMBER   14*1000
...
#define RC_DRIVEBOARD_DRIVEINDIVIDUAL_DATACOUNT        	    4				//[LF, LR, RF, RR]
...
//TCP/////
//Angle Left Right
#define RC_DRIVEBOARD_SETSTEERING_DATAID            	02+_TYPE_COMMAND+_DRIVEBOARD_BOARDNUMBER
#define RC_DRIVEBOARD_SetSteeringAngle_DATATYPE          	int16_t			// (-1000, 1000)-> (0, 359)
#define RC_DRIVEBOARD_SetSteeringAngle_DATACOUNT        	4				//[LF, LR, RF, RR]
#define RC_DRIVEBOARD_SetSteeringAngle_TURNMAXFORWARD   	1000
#define RC_DRIVEBOARD_SetSteeringAngle_TURNMAXREVERSE   	-1000
#define RC_DRIVEBOARD_SetSteeringAngle_TURNZERO         	0

//Watchdog Override
#define RC_DRIVEBOARD_WATCHDOG_DATAID           03+_TYPE_COMMAND+_DRIVEBOARD_BOARDNUMBER
...
//Drive Speed
#define RC_DRIVEBOARD_DRIVE_SPEED_DATAID                01+_TYPE_TELEMETRY+_DRIVEBOARD_BOARDNUMBER
#define RC_DRIVEBOARD_DRIVE_SPEED_DATATYPE			    int16_t //(-1000, 1000)-> (-100%, 100%)
#define RC_DRIVEBOARD_DRIVE_SPEED_DATACOUNT         	6      //[LF, LM, LR, RF, RM,RR]

//Drive Speed
#define RC_DRIVEBOARD_DRIVE_SPEED_DATAID                02+_TYPE_TELEMETRY+_DRIVEBOARD_BOARDNUMBER
#define RC_DRIVEBOARD_DRIVE_SPEED_DATATYPE			    int16_t //(-1000, 1000)-> (-100%, 100%)
#define RC_DRIVEBOARD_DRIVE_SPEED_DATACOUNT         	6      //[LF, LM, LR, RF, RM,RR]
